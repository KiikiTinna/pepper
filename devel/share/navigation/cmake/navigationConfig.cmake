...
if("TRUE" STREQUAL "TRUE")
  set(navigation_SOURCE_PREFIX /home/humanoidrobots/pepper/src/navigation)
  set(navigation_DEVEL_PREFIX /home/humanoidrobots/pepper/devel)
  ...
  set(navigation_INSTALL_PREFIX /home/humanoidrobots/pepper/install)
...
if(NOT "/home/humanoidrobots/pepper/src/navigation/include " STREQUAL " ")
  set(navigation_INCLUDE_DIRS "")
  set(_include_dirs "/home/humanoidrobots/pepper/src/navigation/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'navigation' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/humanoidrobots/pepper/src/navigation/${idir}'.  ${_report}")
    endif()
...
set(depends "roscpp;rospy;std_msgs;pluginlib;costmap_2d")
